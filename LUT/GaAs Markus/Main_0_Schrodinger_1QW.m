...
%==========================================================================
mode.fileNameLUT=(['LUT4D_Julian_nMark_xmol=',num2str(mesh.xmol_well)]); % filename for LUT
...
Tvet=300;
Densityv=0.01*1e12;
lambdavet=790*1-9;%  % 780-825 for Al(0.04)GaAs, step 2 nm
%
%==========================================================================
...
%==========================================================================
% mesh.fileName=['subbands_WQW=',num2str(mesh.Lz*1e9),'nm_','xQW=',num2str(mesh.xmol_well),'.mat'];
mesh.fileName=['subbands_WQW=',num2str(mesh.Lz*1e9),'nm_xB=',num2str(mesh.xmol_barrier),'xQW=',num2str(mesh.xmol_well),'.mat'];
%
...
eval(['save ',mode.fileNameLUT,'_xB=',num2str(mesh.xmol_barrier),'_more.mat ',var_more])
