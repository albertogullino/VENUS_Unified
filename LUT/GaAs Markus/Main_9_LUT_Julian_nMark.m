...
mesh.xmol_well=0.06; % Al molar fraction (well)
...
% Densityv=[0.1 1 2 3 4]*1e12;
% Densityv=3*1e12;

% Full LUT parameters
Tvet=[250:10:500];
Densityv=[0.0001 0.001 0.01 0.1 1 2 2.5:.5:8 9:2:19]*1e12;
lambdavet=[750:1:850]*1e-9;% linspace(830,870,41)*1e-9; % 780-825 for Al(0.04)GaAs, step 2 nm,
%==========================================================================
%
%
%==========================================================================
