...
ILITHO=input('ILITHO: = 1 farlocco (VELM only); = 2 vero (DD included)\n');
% ILITHO=2;
% iStruttura=input('iStruttura? (from List_strNames.m!)\n');

if ILITHO==1
    iStruttura=10; % with TOP mireq
    iStruttura=11; % with TOP mireq and Lg DBR
elseif ILITHO==2
%     iStruttura=15; % with TOP mireq
    iStruttura=16; % with TOP mireq
%     iStruttura=18; % with TOP mireq, single mode
end
