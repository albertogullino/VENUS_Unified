...
% 'calopt', keyboard
global del_n_ag pimra del_n_agInf
calopt_in=struct2cell(calopt_ins);
[Dlam,mod_max,ro_in,zeta,epsT,N,Nref,numodiacc,alim,dk1,par_in,Ev_or_Od,ipolar,...
    pasnui,iridi,ispeedi,iPERD_vol,iplan,del_n_ag,pimra,ianti_gui,box,Ps,ndz,del_n_agInf]=deal(calopt_in{:});
...
if ifp==10
    ...
    %zopt=zeta;
%     ' VEL DD', keyboard
    [St_wave,camzT,Eqw,Eout,xro,fian,lambda,delf,gain,ord,nrAzim,Cu,Pa,ADom,ADcm,Plot,Ppol,Dla_out,imod_err,velm1D]=...
        vel_DD(Nref,N,Topt,ro_in,zopt,xroI,fimaxi,lfi_inp,par_in,r_pil,fil_str,...
