...
% VelmOptions.Dlam=[-.5 10 10 0 .4]; % ORIGINAL, -10????
% if NUMERO_MODI<=2
...
% mode.DT0=10; % degrees, minimum temperature for estimating Dlam_mod
...
if Temperaturei==20
    mode.Imin=2.0e-3/mode.CarrierNorm;  % 1.5 in case of "etched" TJ
