...
if mode.quasi1D==0
    ...
    Width_Contact=8; % rout - rin
     Relief=0;      % oxide radius, um

    Contact=3;      % Contact radius, um   
...
%  mode.verbVELM=0;   % <0 to see VELM results only the first time; >0: always


itutmir=0; % if 1, the "entire" optical structure is studied with thermal (strong discretization)


NUM_Azim_v=[1 1 1 3 3 2 3];  % modi azimutali
NUMERO_MODI_v=[1 1 1 4 3 2 3];  % numero modi in VENUS
