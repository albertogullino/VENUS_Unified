...
% nell'ultimo strato in basso, quello conta 2. Quindi lo strato spesso 17 viene etchato via.
%%%%%%%%%%%%% BTJ %%%%%%%%%%%%%%%%
%TJ_PARAM Start
%Isha_me=1 Ra_me=3|P1 Dr_me=0  n_ext=1  OxVero=0 Nlay_ethc=-5|P4
%%%%%%%%%%%%% BTJ %%%%%%%%%%%%%%%%%
%LcNEGF     	Nd=3e18 1  5	AlGaAs 0.12  1     circle 2.3|P1 Ref 1.6 0 Nmesh=5
%LcNEGF      Nd=3e19 1 10    AlGaAs 0.12  1     circle 2.3|P1 Ref 1.6 0 Nmesh=10
%LcNEGF      Na=2e20 1  3 	AlGaAs 0.12  1     circle 2.3|P1 Ref 1.6 0 Nmesh=3
%Lc          Na=2e20 1  7   	AlGaAs 0.12  1     circle 2.3|P1 Ref 1.6 0 Nmesh=7
%
%Lga  Na=6.00e18 Na=6.00e18 1 17      AlGaAs 0.17 0.17 1 1 Ndis=1 Nmesh=2
%Lga  Na=4.84e18 Na=4.84e18 1 3.5       AlGaAs 0.23 0.23 1 1 Ndis=1 Nmesh=1
%Lga  Na=4.11e18 Na=4.11e18 1 3.5       AlGaAs 0.29 0.29 1 1 Ndis=1 Nmesh=1
%Lga  Na=4.84e18 Na=4.08e18 1 7.9       AlGaAs 0.29 0.57 1 1 Ndis=1 Nmesh=1
%Lga  Na=4.08e18 Na=4.57e18 1 13.1      AlGaAs 0.57 0.86 1 1 Ndis=2 Nmesh=1
%TJ_PARAM End
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
mode.MoveON=0; % impose res=0 after a max number of iterations
...
VelmOptions.Dlam=[-.3 4 5 0 .4]; % ORIGINAL
if NUMERO_MODI<=1
%     VelmOptions.Dlam=[-.5 1 3 0 .4]; % ORIGINAL
       VelmOptions.Dlam=[-1 7 5 0 .4]; % ORIGINAL, 2 modes, dox=2 um
end
KMax=[.25 .20 .16 .15 .11 .10];
...
% DA NON ATTIVARE. Infatti per Litho non ricalcola lo step, e per oxide non aggiorna le perdite: sub_losses_zeta

%mode.DT0=5; % degrees, minimum temperature for estimating Dlam_mod
